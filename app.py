...
FAQ_DATA = {
    "Q1": {
        "title": "Q1. 영양성분 표시 종류",
        "description": "영양성분 검사 종류와 항목",
        "content": """📋 영양성분 검사 종류와 항목

━━━━━━━━━━━━━━━
🔬 KOLAS (ISO/IEC 17025)
수출식품 영양성분 (9대 영양성분, 14대 영양성분)

━━━━━━━━━━━━━━━
🔬 9대 영양성분 (국내기준)
열량, 탄수화물, 단백질, 지방, 포화지방, 트랜스지방, 콜레스테롤, 당류, 나트륨

━━━━━━━━━━━━━━━
🔬 14대 영양성분
1) 9대 영양성분+식이섬유+비타민D+칼슘,철,칼륨 (현 미국 FDA기준)
2) 9대 영양성분+식이섬유+비타민A,비타민C+칼슘,철

━━━━━━━━━━━━━━━
🔬 5대 영양성분
어린이 기호식품: 열량, 당류, 단백질, 포화지방, 나트륨

━━━━━━━━━━━━━━━
🔬 고령친화식품
단백질, 비타민A, 비타민B2, 비타민B3, 비타민C, 비타민D, 칼슘, 칼륨, 식이섬유

━━━━━━━━━━━━━━━
* 비타민, 무기질, 식이섬유(나밤) 등 개별항목 접수도 가능합니다."""
    },
    "Q2": {
        "title": "Q2. 검사 소요기간",
        "description": "검사별 소요 기간 안내",
        "content": """⏱️ 검사 소요기간 안내

━━━━━━━━━━━━━━━
일반적인 검사 소요기간입니다.
검체 및 검사 상황에 따라 변동될 수 있습니다.
...
* 긴급검사가 필요하신 경우 별도 문의 바랍니다."""
    },
    "Q3": {
        "title": "Q3. 검체량 안내",
        "description": "검사별 필요 검체량",
        "content": """📦 검체량 안내
...
━━━━━━━━━━━━━━━
* 검체량이 부족할 경우 검사가 불가할 수 있습니다.
* 냉동/냉장 제품은 아이스박스에 포장하여 발송해주세요."""
    },
    "Q4": {
        "title": "Q4. 검사 신청 방법",
        "description": "검사 신청 절차 안내",
        "content": """📝 검사 신청 방법

━━━━━━━━━━━━━━━
1️⃣ 홈페이지 신청
www.biofl.co.kr 접속 → 회원가입 → 검사신청

2️⃣ 방문 접수
경기도 화성시 동탄대로 354, 903호
...
━━━━━━━━━━━━━━━
📞 문의: 031-8014-2486
📧 이메일: biofl@biofl.co.kr"""
    },
    "Q5": {
        "title": "Q5. 검사비용 안내",
        "description": "검사 항목별 비용",
        "content": """💰 검사비용 안내
...
📌 14대 영양성분: 250,000원
📌 5대 영양성분: 150,000원
📌 미생물 (일반세균/대장균군): 50,000원
📌 중금속 (납/카드뮴): 80,000원

━━━━━━━━━━━━━━━
* 부가세 별도
* 검사 항목에 따라 비용이 달라질 수 있습니다.
* 정확한 비용은 홈페이지 또는 전화 문의 바랍니다.
...
def make_carousel_response(cards: list, buttons: list = None):
    """카카오 챗봇 카드 캐러셀 응답 형식 생성

    Args:
        cards: 카드 리스트 [{"title": "제목", "description": "설명", "button_label": "버튼텍스트", "button_action": "메시지"}]
        buttons: 퀵리플라이 버튼 리스트
    """
    carousel_items = []
    for card in cards:
        item = {
        ...
        # 버튼 추가
        if card.get("button_label"):
            item["buttons"] = [{
                "label": card["button_label"],
                "action": "message",
                "messageText": card.get("button_action", card["button_label"])
            }]

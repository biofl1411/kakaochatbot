...
INSPECTION_MENU = {
    ...
    "submenus": {
        ...
        "영양성분검사": {
            "title": "영양성분검사",
            "buttons": ["검사종류", "9대 영양성분", "14대 영양성분", "처음으로"]
        },
        "소비기한설정": {
            "title": "소비기한설정",
        ...
        "9대 영양성분": {
            "title": "9대 영양성분",
            "buttons": ["영양표시종류", "표시대상확인", "1회제공량산표", "처음으로"]
        },
        "14대 영양성분": {
            "title": "14대 영양성분",
            "buttons": ["영양표시종류", "표시대상확인", "1회제공량산표", "처음으로"]
    ...
    "responses": {
        ...
        "영양표시종류": {
            "text": "📊 영양표시 종류\n\n• 9대 영양성분: 열량, 탄수화물, 당류, 단백질, 지방, 포화지방, 트랜스지방, 콜레스테롤, 나트륨\n\n• 14대 영양성분: 9대 + 식이섬유, 비타민A, 비타민C, 칼슘, 철분"
        },
        "표시대상확인": {
            "text": "✅ 영양표시 대상 확인\n\n영양표시 의무 대상:\n• 레토르트 식품\n• 과자류\n• 빵류\n• 음료류 등\n\n🔗 상세 내용은 홈페이지 참고\n📞 문의: 02-XXX-XXXX"
        },
        "1회제공량산표": {
            "text": "📐 1회제공량 산출표\n\n영양성분 표시를 위한 1회 제공량 기준입니다.\n\n식품유형별 기준이 상이하니 홈페이지를 참고하세요.\n\n🔗 www.biofl.co.kr"
        },
        "방사능": {
            "text": "☢️ 방사능 검사\n\n식품 내 방사능(세슘, 요오드 등) 검출 검사입니다.\n\n• 수입식품 필수\n• 국내식품 자율\n\n📞 문의: 02-XXX-XXXX"
        }
    }
}

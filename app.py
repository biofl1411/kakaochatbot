...
INSPECTION_MENU = {
    ...
    "submenus": {
        "자가품질검사": {
            "title": "자가품질검사",
            "buttons": ["식품", "축산", "검사주기알림", "검사분야", "처음으로"]
        },
        "영양성분검사": {
            "title": "영양성분검사",
            "buttons": ["검사종류", "표시대상확인", "1회제공량산표", "검사분야", "처음으로"]
        },
        "소비기한설정": {
            "title": "소비기한설정",
            "buttons": ["가속실험", "실측실험", "검사수수료", "검사분야", "처음으로"]
        },
        "항생물질": {
            "title": "항생물질",
            "buttons": ["검사종류", "검사분야", "처음으로"]
        },
        "잔류농약": {
            "title": "잔류농약",
            "buttons": ["검사종류", "검사분야", "처음으로"]
        ...
        "방사능": {
            "title": "방사능 검사",
            "buttons": ["검사안내", "검사분야", "처음으로"]
        },
        "비건": {
            "title": "비건 검사",
            "buttons": ["검사안내", "사용키트", "검사분야", "처음으로"]
        },
        "할랄": {
            "title": "할랄 검사",
            "buttons": ["검사안내", "사용키트", "검사분야", "처음으로"]
        ...
        "알레르기": {
            "title": "알레르기 검사 - 검사종류",
            "buttons": ["RT-PCR", "Elisa", "검사분야", "처음으로"]
        },
        "글루텐Free": {
            "title": "글루텐Free 검사",
            "buttons": ["Free기준", "키트", "검사분야", "처음으로"]
        },
        "이물질검사": {
            "title": "이물질검사",
            "buttons": ["금속류", "고무/플라스틱", "기타", "검사분야", "처음으로"]
        },
        "홈페이지안내": {
            "title": "홈페이지 안내",
            "buttons": ["견적서", "의뢰서작성", "할인쿠폰", "검사분야", "처음으로"]
        },
        "성적서문의": {
            "title": "성적서 문의",
            "buttons": ["외국어", "발급문의", "검사분야", "처음으로"]
        },
        "시료접수안내": {
            "title": "시료접수 안내",
            "buttons": ["시료접수", "방문수거", "오시는길", "검사분야", "처음으로"]
        },
        # 이물질검사 - 기타 하위 메뉴
        "기타": {
            "title": "이물질검사 - 기타",
            "buttons": ["손톱", "뼈", "더보기", "이물질검사", "처음으로"]
        },
        "더보기": {
            "title": "이물질검사 - 기타 더보기",
            "buttons": ["탄화물", "원료의일부", "모르겠음", "기타", "처음으로"]
        },
        # 자가품질검사 - 식품/축산 하위 메뉴
        "자가품질검사_식품": {
            "title": "자가품질검사 - 식품",
            "buttons": ["검사주기", "검사항목", "검사수수료", "자가품질검사", "처음으로"]
        },
        "자가품질검사_축산": {
            "title": "자가품질검사 - 축산",
            "buttons": ["검사주기", "검사항목", "검사수수료", "자가품질검사", "처음으로"]
        ...
        "영양성분검사_검사종류": {
            "title": "영양성분검사 - 검사종류",
            "buttons": ["영양표시 종류", "9대 영양성분", "14대 영양성분", "영양성분검사", "처음으로"]
        }
    },
    # 말단 메뉴 응답 (텍스트 응답)
    "responses": {
...
def chatbot():
    ...
    try:
        ...
        menu_items_map = {
            ...
            "글루텐Free": ["Free기준"],
            "소비기한설정": ["가속실험", "실측실험"]
            # 자가품질검사 > 검사주기알림은 별도 핸들러 사용 (링크 버튼 제공)
        }

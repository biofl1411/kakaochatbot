...
알콜 또는 유기산이 포함되어 있나요?""",
            ...
            if step == "열량_추가여부":
                ...
                if user_input == "바로 계산":
                    ...
                    result = get_display_value("열량", kcal)
...
🔽 다른 영양소를 선택하거나 이전을 눌러주세요"""
                    ...
                    return make_response(response_text, ["열량", "탄수화물", "당류", "식이섬유", "단백질", "지방", "포화지방", "트랜스지방", "콜레스테롤", "나트륨", "이전", "처음으로"])
...
🔽 다른 영양소를 선택하거나 이전을 눌러주세요""",
                        ...
                        result = get_display_value("탄수화물", 탄수화물)
